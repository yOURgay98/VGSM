...
export default function SecureError({
  ...
  return (
    <div className="rounded-[var(--radius-window)] border border-[color:var(--border)] bg-[color:var(--surface-strong)] p-5 shadow-[var(--panel-shadow)] backdrop-blur-xl">
      ...
      <p className="mt-2 text-[13px] leading-relaxed text-[color:var(--text-muted)]">
        The console hit an unexpected error. You can retry, or copy error details for a bug report.
      </p>
